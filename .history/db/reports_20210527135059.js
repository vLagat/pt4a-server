...
reportData.all = () => {
    return new Promise((resolve, reject) => {
        ...
        COUNT(IF(dm_status='7281',1, NULL)) 'New Diabetic', COUNT(IF(dm_status='7282',1, NULL)) 'Known Diabetic', COUNT(IF((htn_status='7285' or htn_status='7286') and ((dm_status='7281' or dm_status='7282')),1, NULL)) 'Hypertensive & Diabetic'
        FROM 
